...
<style>
.background1 {
	background-image: url(/static/imgs/universr.jpg);
...
<body class="background1">
	...
	<div id="poem-txt"
		...
		<marquee scrollAmount =5 direction="down" scrolldelay="50">
		《诗词版"流浪地球"》<br /> <span style="font-size: 18px; color: grey">
			-郭鹏 </span><br /> <br /> 西风吹皱东方河，万年地球白发多。 <br /> 流浪星际家何去，满船清梦出银河。</marquee>
